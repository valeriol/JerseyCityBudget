$(function() {
	...
	//Default header text
	var headerText = "Example: Oakland Mayor's Proposed Two-Year Spending (2013-15)"
	...
	if(parameters['reference_years'])
	{
		...
		headerText += " Example: Oakland Mayor's Proposed Spending";
	}
